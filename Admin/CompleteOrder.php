...
<div class="col-sm-9">
    <article>
        <header>
            <h3 style="margin-top:5%">All Complete Orders</h3>
        </header>
        <?php
        ...
        error_reporting(0);
        $query=  "SELECT order_date,order_Id, customer.Name,shiping_address ,amount,status,delivery_date FROM sale_order join customer on sale_order.user_Id = customer.customerId where sale_order.status = 'Completed' ";
